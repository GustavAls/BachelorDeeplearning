...
def init(mdlParams_):
    ...
    mdlParams['dataDir'] = '/scratch/s184400/isic2019/color_augmentation/'
    ...
    ### Training Parameters ###
    # Batch size
    mdlParams['batchSize'] = 15#*len(mdlParams['numGPUs'])
    # Initial learning rate
    mdlParams['learning_rate'] = 0.000015#*len(mdlParams['numGPUs'])
    # Lower learning rate after no improvement over 100 epochspi

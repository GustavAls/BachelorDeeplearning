...
return_folder = r'C:\Users\ptrkm\Bachelor\2019 preproc without cc\training'
...
area_threshold = 0.80
n_croppings = 0
path_test_isic = r'C:\Users\ptrkm\OneDrive\Dokumenter\Bachelor deep learning\Data ISIC\ISIC_2019_Training_Input'
os.chdir(r'C:\Users\ptrkm\OneDrive\Dokumenter\Bachelor deep learning\Data ISIC\ISIC_2019_Training_Input')
            ...
            if write:
                ...
                if write_to_png:
                    if ".jpeg" in j:
                        ...
                        im.save(os.path.join(return_folder,j.name.replace('.jpeg', '.png')))
                    if ".jpg" in j:
                        im = Image.fromarray(new_image).convert('RGB')
                        im.save(os.path.join(return_folder,j.name.replace('.jpg', '.png')))
                else:
                    im = Image.fromarray(new_image).convert('RGB')

                    im.save(os.path.join(return_folder,j))

...
network_list_eff = ['efficientnet_b0_rr','efficientnet_b1_rr','efficientnet_b2_rr','efficientnet_b3_rr','efficientnet_b4_rr',
                'efficientnet_b5_rr','efficientnet_b6_rr','efficientnet_b0_ss','efficientnet_b1_ss','efficientnet_b2_ss',
                'efficientnet_b3_ss','efficientnet_b4_ss','efficientnet_b5_ss','efficientnet_b6_ss']
network_list_other = ['res101','resnext_101_32_8_wsl','nasnetamobile','se_resnet101']

network_list_eff = ['2019_rr.test_' + i if 'rr' in i else '2019.test_' + i for i in network_list_eff]
network_list_other = ['2019_rr.test_' + i +'_rr' for i in network_list_other]

network_list = network_list_other+network_list_eff
...
if sys.argv[1] == 'all':
    for networks_peter in network_list:
        ...
        pc_cfg = importlib.import_module('pc_cfgs.' + networks_peter)
